...
SECTIONS_2D: list[tuple[str, list[tuple[str, str, str]]]] = [
    ...
    ("CASH FLOW", [
        ...
        ("subsidiaries_obtained_control", "Subsidiaries obtained control (M&A)", "money"),
        ("subsidiaries_lost_control", "Subsidiaries lost control (divestiture)", "money"),
        ("subsidiaries_purchased", "Subsidiaries purchased (no control)", "money"),
    ...
    ("LIQUIDEZ", [
        ...
        ("quick_ratio", "Quick ratio (excl. inventory)", "ratio"),
        ("cash_ratio", "Cash ratio (cash / current liab.)", "ratio"),
    ]),
    ("SOLVENCIA / APALANCAMIENTO", [
        ("total_debt", "Total debt", "money"),
        ("net_debt", "Net debt", "money"),
        ("debt_to_equity", "Debt / Equity", "ratio"),
        ("debt_to_ebitda", "Debt / EBITDA (LTM)", "ratio"),
        ("net_debt_to_ebitda", "Net debt / EBITDA (LTM)", "ratio"),
        ("equity_ratio", "Equity / Total assets", "pct"),
    ]),
    ("COBERTURA", [
        ("interest_coverage", "Interest coverage (EBIT / |int.expense|)", "ratio"),
        ("interest_coverage_ebitda", "Interest coverage (EBITDA / |int.expense|)", "ratio"),
        ("cash_interest_coverage", "Cash interest coverage (OCF / |int.paid|)", "ratio"),
        ("cfo_to_debt", "OCF / Total debt", "pct"),
    ...
    ("CASH FLOW (métricas)", [
        ("ocf_margin", "OCF margin (OCF / Revenue)", "pct"),
        ("fcf_margin", "FCF margin (FCF / Revenue)", "pct"),
        ("cash_conversion", "Cash conversion (OCF / Net income)", "ratio"),
        ("fcf_to_net_income", "FCF / Net income", "ratio"),
        ("capex_intensity", "Capex intensity (|capex| / Revenue)", "pct"),
        ("capex_to_dna", "Capex / D&A (growth vs maintenance)", "ratio"),
    ]),
    ("POLÍTICA DE CAPITAL", [
        ("payout_ratio", "Payout ratio (|div paid| / Net income)", "pct"),
        ("dividend_coverage_fcf", "Dividend coverage (FCF / |div paid|)", "ratio"),
    ]),
    ("CRECIMIENTO YoY", [
...
SECTIONS_2F: list[tuple[str, list[tuple[str, str, str]]]] = [
    ...
    ("CALIDAD DE CARTERA", [
        ("npl_ratio", "NPL ratio (proxy: vencidos+judicial / cartera)", "pct"),
        ("cost_of_risk", "Cost of risk (|LLP| / avg loans)", "pct"),
    ]),
    ("RENTABILIDAD", [
        ("nim", "NIM (NII / avg loans)", "pct"),
        ("efficiency_ratio", "Efficiency ratio (|opex| / total revenue)", "pct"),
        ("effective_tax_rate", "Effective tax rate", "pct"),
        ("roa", "ROA (avg total assets)", "pct"),
        ("roe", "ROE (avg equity)", "pct"),
    ]),
